...
<xsl:choose>
    ...
    <xsl:when test="$clause = 4">
        <xsl:call-template name="itemFieldDisplay.dc.contributor.editor">
            <xsl:with-param name="clause" select="$clause" />
            <xsl:with-param name="phase" select="$phase" />
            <xsl:with-param name="otherPhase" select="$otherPhase" />
        </xsl:call-template>
    ...
    <xsl:when test="$clause = 5">
        <xsl:call-template name="itemFieldDisplay.dc.contributor.illustrator">
            <xsl:with-param name="clause" select="$clause" />
            <xsl:with-param name="phase" select="$phase" />
            <xsl:with-param name="otherPhase" select="$otherPhase" />
        </xsl:call-template>
    ...
    <xsl:when test="$clause = 7">
        <xsl:call-template name="itemFieldDisplay.dc.subject.lcsh">
            <xsl:with-param name="clause" select="$clause" />
            <xsl:with-param name="phase" select="$phase" />
            <xsl:with-param name="otherPhase" select="$otherPhase" />
        </xsl:call-template>
    ...
    <xsl:when test="$clause = 21">
        <xsl:call-template name="itemFieldDisplay.dc.type.genre">
            <xsl:with-param name="clause" select="$clause" />
            <xsl:with-param name="phase" select="$phase" />
            <xsl:with-param name="otherPhase" select="$otherPhase" />
        </xsl:call-template>
    </xsl:when>
    <xsl:when test="$clause = 22">
